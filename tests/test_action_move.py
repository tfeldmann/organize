...
def test_tilde_expansion(mock_exists, mock_move, mock_remove, mock_mkdir):
    path = Path('~') / 'test.py'
...
def test_into_folder(mock_exists, mock_move, mock_remove, mock_mkdir):
    path = Path('~') / 'test.py'
    mock_exists.return_value = False
...
def test_overwrite(mock_exists, mock_move, mock_remove, mock_mkdir):
    path = Path('~') / 'test.py'
...
def test_already_exists(mock_exists, mock_move, mock_remove, mock_mkdir):
    path = Path('~') / 'test.py'
...
def test_already_exists_multiple(mock_exists, mock_move, mock_remove, mock_mkdir):
    path = Path('~') / 'test.py'
...
def test_makedirs(mock_parent, mock_move, mock_remove):
    path = Path('~') / 'test.py'
...
def test_attrs(mock_exists, mock_move, mock_remove, mock_mkdir):
    path = Path('~') / 'test.py'
    mock_exists.return_value = False
...
def test_path(mock_exists, mock_move, mock_remove, mock_mkdir):
    path = Path('~') / 'test.py'
    mock_exists.return_value = False
    move = Move(
